...
class SearchEntradasHuacalesUseCase @Inject constructor(
    private val repository: EntradasHuacalesRepository
) {
    operator fun invoke(query: String): Flow<List<EntradasHuacalesEntity>> {
        return repository.searchEntradas(query)
    }
}
